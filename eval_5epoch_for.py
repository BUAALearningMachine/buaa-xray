...
from data.SIXray import SIXray_CLASSES as labelmap, SIXrayDetection, BaseTransform, \
    SIXrayAnnotationTransform, TEST_SET_PATH
...
parser.add_argument('--trained_model',
                    default="weights/ssd_repulsion.pth", type=str,
...
parser.add_argument('--SIXray_root', default=TEST_SET_PATH,
...
annopath = os.path.join(args.SIXray_root, 'Annotation', 'battery_%s.txt')
imgpath = os.path.join(args.SIXray_root, 'Image', 'battery_%s.jpg')
